    ...
    <View style={styles.container}>
      <ScrollView>     
            ...
            <Header containerStyle={{backgroundColor:'transparent',alignItems:'center',justifyContent:'center',borderBottomWidth:0,height:hp('13')}}
             leftComponent={
            <Icon name='back' size={35} style={{color:'white',marginTop:hp('1')}}
            onPress={()=>{navigation.goBack()}}
            />}
            centerComponent={<Text style={{color:'white',fontWeight:'bold',fontSize:18,
            marginTop:hp('1')}}>Request A Quote</Text>
      ...
      <KeyboardAvoidingView>
            <View style={styles.panel}>
                        ...
                        <View>
                              ...
                              <Text style={{fontSize:20,fontWeight:'bold'}}>Request A Free Quote</Text>
                  ...
                  <View style={{borderWidth:0,height:hp('15')}}>
                        <Hoshi
                                    style={{height:hp('20')}}
                                    inputContainerStyle={{height:hp('20')}}
                                    username
                                    label={'Your Message'}
                                    autoCompleteType='off'
                                    borderColor={'#2F4191'}
